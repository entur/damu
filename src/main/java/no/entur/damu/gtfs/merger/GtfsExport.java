...
public enum GtfsExport {
  ...
  private static class GtfsHeaders {
    ...
    private static final String[] AGENCY_TXT_HEADERS = splitHeaders(
      "agency_id,agency_name,agency_url,agency_timezone,agency_phone"
    );
    private static final String[] CALENDAR_TXT_HEADERS = splitHeaders(
      "service_id,monday,tuesday,wednesday,thursday,friday,saturday,sunday,start_date,end_date"
    );
    private static final String[] CALENDAR_DATES_TXT_HEADERS = splitHeaders(
      "service_id,date,exception_type"
    );
    private static final String[] ROUTES_TXT_HEADERS = splitHeaders(
      "agency_id,route_id,route_short_name,route_long_name,route_type,route_desc,route_url,route_color,route_text_color"
    );
    private static final String[] SHAPES_TXT_HEADERS = splitHeaders(
      "shape_id,shape_pt_sequence,shape_pt_lat,shape_pt_lon,shape_dist_traveled"
    );
    private static final String[] STOPS_TXT_HEADERS = splitHeaders(
    ...
    private static final Map<String, String[]> HEADERS_FOR_BASIC_AND_EXTENDED_EXPORT =
      Map.of(
        ...
        STOP_TIMES_TXT_HEADERS,
        GtfsConstants.TRANSFERS_TXT,
        TRANSFERS_TXT_HEADERS,
