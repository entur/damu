...
public final class Constants {
  ...
  public static final String EXPORT_GTFS_MERGED = "ExportGtfsMerged";
  public static final String EXPORT_GTFS_BASIC_MERGED = "ExportGtfsBasicMerged";
  ...
  public static final String FILE_PARENT_COLLECTION =
    "RutebankenFileParentCollection";
  ...
  public static final String CHOUETTE_REFERENTIAL =
  ...
  public static final String CURRENT_AGGREGATED_GTFS_FILENAME =
    "aggregated-gtfs.zip";
  public static final String CURRENT_AGGREGATED_NETEX_FILENAME =
    "aggregated-netex.zip";
  public static final String CURRENT_FLEXIBLE_LINES_NETEX_FILENAME =
    "flexible-lines.zip";

  public static final String GRAPH_COMPATIBILITY_VERSION =
    "RutebankenGraphCompatibilityVersion";
  ...
  public static final String FILE_TARGET_MD5 =
    "RutebankenMd5SumRecordedForTargetFile";

  public static final String FILE_APPLY_DUPLICATES_FILTER =
    "RutebankenApplyDuplicateFilter";
  public static final String FILE_APPLY_DUPLICATES_FILTER_ON_NAME_ONLY =
    "RutebankenApplyDuplicateFilterOnNameOnly";
  public static final String FILE_SKIP_STATUS_UPDATE_FOR_DUPLICATES =
    "RutebankenSkipStatusUpdateForDuplicateFiles";

  public static final String BLOBSTORE_PATH_INBOUND = "inbound/received/";

  public static final String CHOUETTE_JOB_STATUS_URL =
    "RutebankenChouetteJobStatusURL";
  public static final String CHOUETTE_JOB_ID = "RutebankenChouetteJobId";
  public static final String CHOUETTE_JOB_STATUS_ROUTING_DESTINATION =
    "RutebankenChouetteJobStatusRoutingDestination";
  public static final String CHOUETTE_JOB_STATUS_JOB_TYPE =
    "RutebankenChouetteJobStatusType";
  public static final String CHOUETTE_JOB_STATUS_JOB_VALIDATION_LEVEL =
    "RutebankenChouetteJobStatusValidationLevel";

  public static final String ANTU_VALIDATION_REPORT_ID =
  ...
  public static final String PROVIDER_BLACK_LIST =
    "RutebankenProviderBlackList";
  public static final String PROVIDER_WHITE_LIST =
    "RutebankenProviderWhiteList";
  ...
  public static final String OTP_BUILD_CANDIDATE =
    "RutebankenOtpBuildCandidate";
  ...
  public static final String VALIDATION_STAGE_PREVALIDATION =
    "EnturValidationStagePreValidation";
  public static final String VALIDATION_STAGE_EXPORT_NETEX_POSTVALIDATION =
    "EnturValidationStageExportNetexPostValidation";
  public static final String VALIDATION_STAGE_EXPORT_NETEX_BLOCKS_POSTVALIDATION =
    "EnturValidationStageExportNetexBlocksPostValidation";

  public static final String VALIDATION_STAGE_FLEX_POSTVALIDATION =
    "EnturValidationStageFlexPostValidation";

  public static final String VALIDATION_STAGE_EXPORT_MERGED_POSTVALIDATION =
    "EnturValidationStageExportMergedPostValidation";
  ...
  public static final String VALIDATION_PROFILE_TIMETABLE_SWEDEN =
    "TimetableSweden";
  public static final String VALIDATION_PROFILE_TIMETABLE_FINLAND =
    "TimetableFinland";
