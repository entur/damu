...
public final class NetexDatasetParserUtil {
     ...
     * The common files for non-flexible lines have precedence over those refering to flexible lines.
     *
     * @param parser
    ...
    public static NetexEntitiesIndex parse(NetexParser parser, ZipInputStream zipInputStream, NetexEntitiesIndex index) throws IOException {
        ...
        while (zipEntry != null) {
            // parse the common files generated by chouette in the end so that they do not get overwritten by the flexible common files
