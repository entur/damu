...
//
//import static no.entur.damu.Constants.EXPORT_GTFS_BASIC_MERGED;
//
...
//
//  @Value(
//    "${gtfs.basic.export.merged.file.name:rb_norway-aggregated-gtfs-basic.zip}"
//  )
...
//
//    singletonFrom(
//      "google-pubsub:{{damu.pubsub.project.id}}:GtfsBasicExportMergedQueue"
//    )
...
//        LoggingLevel.INFO,
//        correlation() +
//        "Aggregated ${exchangeProperty.CamelAggregatedSize} GTFS Basics export requests (aggregation completion triggered by ${exchangeProperty.CamelAggregatedCompletedBy})."
//      )
...
//      .setBody(constant(""))
//      .setProperty(
//        Constants.PROVIDER_BLACK_LIST,
//        constant(createProviderBlackList())
//      )
