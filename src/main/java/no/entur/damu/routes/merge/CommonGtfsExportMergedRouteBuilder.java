  ...
  public void configure() throws Exception {
    ...
    from("direct:exportMergedGtfs")
      .log(
        ...
        getClass().getName(),
        correlation() +
        "Start export of merged GTFS file: ${header." +
        FILE_NAME +
        "}"
      )
      ...
      .log(
        ...
        getClass().getName(),
        correlation() +
        "Completed export of merged GTFS file: ${header." +
        FILE_NAME +
        "}"
      )
      .doFinally()
    ...
    from("direct:fetchLatestGtfs")
      .log(
        LoggingLevel.DEBUG,
        getClass().getName(),
        correlation() + "Fetching gtfs files for all providers."
      )
      .process(e ->
        new File(
      ...
      .log(
        ...
        getClass().getName(),
        correlation() +
        "No gtfs files configured for inclusion in export '${exchangeProperty.fileName}', terminating export."
      )
      .stop()
      .end()
      .split(body())
    ...
    from("direct:mergeGtfs")
      .log(
        LoggingLevel.DEBUG,
        getClass().getName(),
        correlation() + "Merging gtfs files for all providers."
      )
      .process(exchange -> {
        ...
        String jobAction = exchange
          .getIn()
          .getHeader(Constants.JOB_ACTION, String.class);
