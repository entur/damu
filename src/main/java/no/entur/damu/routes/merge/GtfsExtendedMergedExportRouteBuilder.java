...
//
//    singletonFrom(
//      "google-pubsub:{{marduk.pubsub.project.id}}:GtfsExportMergedQueue"
//    )
//      .autoStartup("{{gtfs.export.autoStartup:true}}")
...
//        LoggingLevel.INFO,
//        correlation() +
//        "Aggregated ${exchangeProperty.CamelAggregatedSize} GTFS export merged requests (aggregation completion triggered by ${exchangeProperty.CamelAggregatedCompletedBy})."
//      )
//      .to("direct:exportGtfsExtendedMerged")
//      .to(
//        ExchangePattern.InOnly,
//        "google-pubsub:{{marduk.pubsub.project.id}}:GtfsBasicExportMergedQueue"
//      )
